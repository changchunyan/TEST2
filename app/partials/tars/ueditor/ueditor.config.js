...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , iframeCssUrl: URL + 'partials/tars/ueditor/themes/iframe.css' //给编辑器内部引入一个css文件

        , initialFrameWidth: 525  //初始化编辑器宽度,默认906
        , initialFrameHeight: 250  //初始化编辑器高度,默认450
