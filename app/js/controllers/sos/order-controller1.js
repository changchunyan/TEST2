...
angular.module('ywsApp')
    .controller('OrderManagementController', ['$scope', '$timeout', '$location', '$routeParams', '$modal', '$rootScope',
        ...
        'LeadsStudentService', 'CoursePlanService', 'UserService', 'AuthenticationService', 'CrmChargingSchemeService', 'ColEdit', 'CustomerStudentCourseService',
        function ($scope, $timeout, $location, $routeParams, $modal, $rootScope, FileUploader, $base64, SweetAlert,
            localStorageService, OrderService, CommonService, LeadsStudentService, CoursePlanService, UserService, AuthenticationService, CrmChargingSchemeService, ColEdit, CustomerStudentCourseService) {
            ...
            $scope.checkPhone = function () {
                if ($scope.order.leadPhone && $scope.order.leadPhone != '') {
                    /*OrderService.checkPhone($scope.order.leadPhone).then(function (result) {
            ...
            $scope.newCustomerAndOrder = function () {
                //var obj = {'crmStudentId':row.crm_student_id,'name':row.name};
            ...
            $scope.callServerOneTab = function callServerOneTab(tableState) {
                ...
                //            	if(AuthenticationService.currentUser().position_id == Constants.PositionID.HEADMASTER
                //            			|| AuthenticationService.currentUser().position_id == Constants.PositionID.FINANCIAL_AFFAIRS){
                //            		$scope.hasChargeBackOrderPermission = true ;
                //            	}
            ...
            $scope.orderMediaChannel1Change = function orderMediaChannel1Change() {
                $scope.order.mediaChannelId1 = $scope.orderFilter.mediaChannelId1;
            ...
            $scope.doExportOrderCheck = function () {
                ...
                var exportTableStyle = {
                    ...
                    columns: [
                        ...
                        { columnid: 'mediaChannelId1Name', title: '签约渠道' },
                        { columnid: 'mediaChannelId2Name', title: '渠道详情' },
            ...
            $scope.doExport = function () {
                ...
                var exportTableStyle = {
                    ...
                    columns: [
                        ...
                        { columnid: 'orderType', title: '订单类型' },
                        { columnid: 'signingChannel', title: '签约渠道' },
                        { columnid: 'channelDetail', title: '渠道详情' },
                        { columnid: 'achievementPerson', title: '业绩所属人' },
                        { columnid: 'belongStudentOfficer', title: '所属学习顾问' },
                        { columnid: 'trailListeningTeacher', title: '试听教师' },
                    ],
            ...
            $scope.KSDatas = [{ "name": "小于20", "id": 26 }, { "name": "20至49", "id": 27 }, { "name": "50至99", "id": 28 }, { "name": "100至199", "id": 29 }, { "name": "200及已上", "id": 30 }, { "name": "自定义", "id": 8 }];

            $scope.JEDatas = [{ "name": "小于1万", "id": 31 }, { "name": "1-3万", "id": 32 }, { "name": "3-5万", "id": 33 }, { "name": "5-10万", "id": 34 }, { "name": "10万以上", "id": 35 }, { "name": "自定义", "id": 8 }];
            /**
             * 改变查询更多按钮
             */
            ...
            function getDetail(obj) {
                ...
                $scope.order = angular.copy(obj);
                $scope.modalTitleDetail = '查看';
                $scope.modal = $modal({ scope: $scope, templateUrl: "partials/sos/order/orderCourseDetail.html", show: true });
            ...
            $scope.showChargeModal = function showChargeModal() {
                ...
                CommonService.getGradeIdSelect().then(function (result) {
                    ...
                    $scope.modal = $modal({ scope: $scope, templateUrl: "optimize/modal/order/modal.firstCharge.html", show: true });
                });
            }
            //先收费的额手机 重复验证
            ...
            */
            function detailOrderFirstCharge(obj) {
                $scope.order = angular.copy(obj);
                $scope.modalTitleDetail = '查看';
                $scope.modal = $modal({ scope: $scope, templateUrl: "optimize/modal/order/detail.firstCharge.html", show: true });
                $scope.getOrderAchievementRatios();//获取订单的业绩比例
                $scope.getOrderPayments();
            }
            function editOrderFirstCharge(obj) {
                ...
                $scope.modal = $modal({ scope: $scope, templateUrl: "optimize/modal/order/update.firstCharge.html", show: true });
                $scope.getOrderAchievementRatios();//获取订单的业绩比例
                $scope.getOrderPayments();
            }
    ...
    ]).controller('OrderAuditTransferController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'OrderTransferService', 'CommonService',
        function ($scope, $modal, $rootScope, SweetAlert, OrderService, OrderTransferService, CommonService) {
            //加载课程类型
            $scope.callServerCourseTeachingTypeSelect = function callServerCourseTeachingTypeSelect() {
                CommonService.getCourseTeachingTypeSelect().then(function (result) {
                    $scope.courseTeachingType = result.data;
    ...
    ]).controller('OrderDetailTransferController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'OrderTransferService', 'CommonService',
        function ($scope, $modal, $rootScope, SweetAlert, OrderService, OrderTransferService, CommonService) {
            //加载课程类型
            $scope.callServerCourseTeachingTypeSelect = function callServerCourseTeachingTypeSelect() {
                CommonService.getCourseTeachingTypeSelect().then(function (result) {
    ...
    ]).controller('OrderAddTransferTopupController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'OrderTransferService', 'CommonService', 'LeadsStudentService',
        function ($scope, $modal, $rootScope, SweetAlert, OrderService, OrderTransferService, CommonService, LeadsStudentService) {
            $scope.order.orderNos = [];
    ...
    ]).controller('OrderAuditTransferTopupController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'OrderTransferService', 'CommonService',
        function ($scope, $modal, $rootScope, SweetAlert, OrderService, OrderTransferService, CommonService) {
            //加载课程类型
            $scope.callServerCourseTeachingTypeSelect = function callServerCourseTeachingTypeSelect() {
                CommonService.getCourseTeachingTypeSelect().then(function (result) {
    ...
    .controller('OrderDetailTransferTopupController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'OrderTransferService', 'CommonService',
        function ($scope, $modal, $rootScope, SweetAlert, OrderService, OrderTransferService, CommonService) {
            //加载课程类型
            $scope.callServerCourseTeachingTypeSelect = function callServerCourseTeachingTypeSelect() {
                CommonService.getCourseTeachingTypeSelect().then(function (result) {
    ...
    .controller('OrderChargeController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'CommonService',
        function ($scope, $modal, $rootScope, SweetAlert, OrderService, CommonService) {
    ...
    .controller('OrderChargebackController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'CommonService', function ($scope, $modal, $rootScope, SweetAlert, OrderService, CommonService) {
        $scope.orderTypeSelect = [{ name: '新签', id: 1 }, { name: '续费', id: 2 }, { name: '返课', id: 3 }, { name: '推荐', id: 5 }, { name: '赠课', id: 8 }];
    ...
    .controller('OrderChargeBackTopupController', ['$scope', '$timeout', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'CommonService',
        function ($scope, $timeout, $modal, $rootScope, SweetAlert, OrderService, CommonService) {
            $scope.refundTopup = refundTopup;
            $scope.orderTypeSelect = [{ name: '新签', id: 1 }, { name: '续费', id: 2 }, { name: '返课', id: 3 }, { name: '推荐', id: 5 }, { name: '赠课', id: 8 }];
            $scope.onIsAuditionSelect = function onIsAuditionSelect() {
                $scope.order.orderCoursesNew = [];
    ...
    .controller('OrderAddTopupController', ['$scope', '$mtModal', '$timeout', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'CommonService', 'AuthenticationService', 'CrmChargingSchemeService', 'CustomerStudentService', 'CoursePlanService', 'LeadsStudentService', 'CustomerStudentCourseService',
        function ($scope, $mtModal, $timeout, $modal, $rootScope, SweetAlert, OrderService, CommonService, AuthenticationService, CrmChargingSchemeService, CustomerStudentService
            , CoursePlanService, LeadsStudentService, CustomerStudentCourseService) {
            $scope.orderTypeSelect = [{ name: '新签', id: 1 }, { name: '续费', id: 2 }, { name: '返课', id: 3 }, { name: '推荐', id: 5 }, { name: '赠课', id: 8 }];
            ...
            function _getOrderCopy(obj) {
                ...
                if (obj.constructor == Array) {
                    obj.forEach(function (i, index) {
                        obj[index].contractEndDate = _contractEndDate
                        obj[index].contractStartDate = _contractStartDate
                    })
                } else {
            ...
            function judgeAmount() {
                if ($scope.order.recharge.privilegeAmount - $scope.order.recharge.totalPrice > 0) {
                    ...
                    $scope.order = _getOrderCopy($scope.orderRecharge)
                    return false;
                }
            ...
            function resetOrderProtocol() {
                $scope.order.recharge.createLead = '';
                $scope.order.recharge.name = '';
                $scope.order.recharge.leadPhone = '';
                $scope.order.recharge.leadMediaChannelId1 = '';
                $scope.order.recharge.leadMediaChannelId2 = '';
                $scope.order.recharge.orderChargingName = '';
                $scope.order.recharge.orderTeacherLevel = '';
                $scope.order.recharge.orderChargingPrice = '';
                $scope.order.recharge.totalPrice = '';
                $scope.order.recharge.privilegeRatio = '';
                $scope.order.recharge.privilegeAmount = '';
                $scope.order.recharge.realTotalAmount = '';
            }
                    ...
                    SweetAlert.swal({
                        ...
                        if (confirm) {
                            ...
                            if ($scope.addProtocolModal) {
                                ...
                                $scope.addProtocolModal = $modal({ scope: $scope, templateUrl: mtModal.addProtocol, show: true });
                            }
                        } else {
                            $scope.saveOrder($scope.orderRecharge);
                        }
                    });
                } else if (orderElement.orderType == 8) {
                    $scope.order.recharge.masterSlaveRelation = 1;
                    $scope.orderRecharge.push($scope.order.recharge);
                    $scope.saveOrder($scope.orderRecharge);
                }
            }
            ...
            $scope.saveOrder = function saveOrder(obj) {
                ...
                if (obj[0].orderNo == undefined && (obj[0].nakedContract == undefined || !obj[0].nakedContract)) {
                    SweetAlert.swal({
    ...
    .controller('OrderUpdateTopupController', ['$scope', '$mtModal', '$timeout', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'CommonService', 'AuthenticationService',
        'CrmChargingSchemeService', 'CustomerStudentService', 'CoursePlanService',
        function ($scope, $mtModal, $timeout, $modal, $rootScope, SweetAlert, OrderService, CommonService, AuthenticationService, CrmChargingSchemeService, CustomerStudentService, CoursePlanService) {

            $scope.orderTypeSelect = [{ name: '新签', id: 1 }, { name: '续费', id: 2 }, { name: '推荐', id: 5 }, { name: '赠课', id: 8 }];
            $scope.isCourseAuditionSelect = [{ name: '是', id: 1 }, { name: '否', id: 0 }];
            $scope.order.supplementaryFee = 0;
            $scope.order.orderCourses = [];
            // 定义业绩的对象
    ...
    .controller('OrderAuditTopupController', ['$scope', '$timeout', '$modal', '$rootScope', 'SweetAlert', 'OrderService',
        function ($scope, $timeout, $modal, $rootScope, SweetAlert, OrderService) {
            $scope.orderTypeSelect = [{ name: '新签', id: 1 }, { name: '续费', id: 2 }, { name: '返课', id: 3 }, { name: '推荐', id: 5 }, { name: '赠课', id: 8 }];
            $scope.isCourseAuditionSelect = [{ name: '是', id: 1 }, { name: '否', id: 0 }];
            $timeout(function () {
                $("[data-toggle='tooltip']").tooltip();
    ...
    .controller('OrderDetailTopupController', ['$scope', '$timeout', '$modal', '$rootScope', 'SweetAlert', 'OrderService',
        function ($scope, $timeout, $modal, $rootScope, SweetAlert, OrderService) {
            $scope.orderTypeSelect = [{ name: '新签', id: 1 }, { name: '续费', id: 2 }, { name: '返课', id: 3 }, { name: '推荐', id: 5 }, { name: '赠课', id: 8 }];
            $scope.isCourseAuditionSelect = [{ name: '是', id: 1 }, { name: '否', id: 0 }];
            $scope.orderRuleSelect = [{ name: '1小时', id: 1 }, { name: '40分钟', id: 2 }];
    ...
    .controller('OrderDetailOTOController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService',
    ...
    .controller('orderSelectClassController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService', 'AuthenticationService', 'ClassManagementService',
        function ($scope, $modal, $rootScope, SweetAlert, OrderService, AuthenticationService, ClassManagementService) {
    ...
    .controller('achievementRatioController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'DepartmentService', 'PositionService', 'OrderService',
        function ($scope, $modal, $rootScope, SweetAlert, DepartmentService, PositionService, OrderService) {
    ...
    .controller('PaymentListController', ['$scope', '$modal', '$rootScope', 'SweetAlert', 'OrderService',
        function ($scope, $modal, $rootScope, SweetAlert, OrderService) {
            ...
            $scope.payDatas = [{ "name": "今日", "id": 1 }, { "name": "明日", "id": 9 }, { "name": "本周", "id": 10 }, { "name": "下周", "id": 11 }, { "name": "本月", "id": 13 }, { "name": "下月", "id": 15 }, { "name": "自定义", "id": 8 }];
            $scope.contractDatas = [{ "name": "今日", "id": 1 }, { "name": "明日", "id": 9 }, { "name": "本周", "id": 10 }, { "name": "下周", "id": 11 }, { "name": "本月", "id": 13 }, { "name": "下月", "id": 15 }, { "name": "自定义", "id": 8 }];
